...
namespace Svg.Editor.Views.UWP
{
    ...
    internal class ManipulationInputProcessor : IDisposable
    {
        ...
        public ManipulationInputProcessor(CustomGestureRecognizer gestureRecognizer, UIElement referenceFrame)
        {
        ...
        private void ElementOnManipulateCompleted(object sender, ManipulationCompletedRoutedEventArgs e)
        {
            _isManipulated = false;
        }


        private void ElementOnManipulateStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
            _isManipulated = true;
        }
