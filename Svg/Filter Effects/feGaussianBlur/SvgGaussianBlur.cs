...
namespace Svg.FilterEffects
{
    ...
    public class SvgGaussianBlur : SvgFilterPrimitive
    {
        ...
        public Bitmap Apply(Image inputImage)
        {
            ...
            if (bitmapSrc == null) bitmapSrc = Bitmap.Create(inputImage);//new Bitmap(inputImage);

            using (RawBitmap src = new RawBitmap(bitmapSrc))
            {
                using (RawBitmap dest = new RawBitmap(Bitmap.Create(inputImage.Width, inputImage.Height)))
                {
        ...
        public float StdDeviation
        {
            ...
            set
            {
                ...
                _stdDeviation = value;
                this.Attributes["stdDeviation"] = value;
                PreCalculate();
            }
        }
