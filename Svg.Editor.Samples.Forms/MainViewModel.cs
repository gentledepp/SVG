...
using Svg.Editor.Samples.Forms.Resources.svg;
using Svg.Editor.Samples.Forms.Services;
using Svg.Editor.Samples.Forms.Tools;
...
namespace Svg.Editor.Samples.Forms
{
    ...
    {
        public MainViewModel(ContentPage contentPage)
        {
            ...
            SvgEngine.Register<ITextInputService>(() => new TextInputService(contentPage));
			SvgEngine.Register<IPickImageService>(() => new FormsPickImageService());
            SvgEngine.Register<IPinInputService>(() => new PinInputService(contentPage));
