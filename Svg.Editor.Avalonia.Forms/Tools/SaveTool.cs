...
namespace Svg.Editor.Avalon.Forms.Tools
{
    public class SaveTool : ToolBase
    {
        ...
        public override async Task Initialize(ISvgDrawingCanvas ws)
        {
            ...
            Commands = new[]
            {
                ...
                (obj) => ws.Document != null, sortFunc: (x)=>1, description: LocalizationService.GetString("Svg.Editor.SaveTool.Description")),
                ...
                }, description: LocalizationService.GetString("Svg.Editor.SaveTools.Save")),
